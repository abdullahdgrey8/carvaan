    ...
    if (existingCar.length > 0) {
      ...
      await db
        ...
        .set({
          ...
          engineSize: typeof carAd.specifications?.engineSize === "number" ? carAd.specifications.engineSize : null,
          horsepower: typeof carAd.specifications?.horsepower === "number" ? carAd.specifications.horsepower : null,
          torque: typeof carAd.specifications?.torque === "number" ? carAd.specifications.torque : null,
          fuelEconomy: typeof carAd.specifications?.fuelEconomy === "number" ? carAd.specifications.fuelEconomy : null,
          doors: typeof carAd.specifications?.doors === "number" ? carAd.specifications.doors : null,
          seats: typeof carAd.specifications?.seats === "number" ? carAd.specifications.seats : null,
